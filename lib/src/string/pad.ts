...
import { EMPTY, LENGTH, UNDEF_VALUE } from "../internal/constants";
 ...
 * character (U+0020).
 */
export const strPadStart: (value: string, targetLength: number, padString?: string) => string = _unwrapFunction(PAD_START, UNDEF_VALUE, polyStrPadStart);
 ...
 */
export const strPadEnd: (value: string, targetLength: number, padString?: string) => string = _unwrapFunction(PAD_END, UNDEF_VALUE, polyStrPadEnd);
