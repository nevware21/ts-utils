...
import { INDEX_OF, LAST_INDEX_OF } from "../internal/constants";
 ...
 * ```
 */
export const strLastIndexOf: (value: string, searchString: string, position?: number) => number = _unwrapFunction(LAST_INDEX_OF);
