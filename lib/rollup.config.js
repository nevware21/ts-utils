...
export default [
    //rollupModule("dist/es5", "dist-es5", false),
    //rollupModule("dist/es6", "dist-es6", false),
    ...
    // rollupConfigFactory("dist/es5/mod", "bundle/es5", false, "node", "umd"),
    // rollupConfigFactory("dist/es5/mod", "bundle/es5", true, "node", "umd"),
    ...
    // rollupConfigFactory("dist/es6/mod", "bundle/es6", false, "node", "umd"),
    // rollupConfigFactory("dist/es6/mod", "bundle/es6", true, "node", "umd"),
