...
// Handle both default-export and named/CommonJS export shapes across magic-string versions.
let MagicString = MagicStringPkg;
if (MagicStringPkg.default !== undefined) {
    MagicString = MagicStringPkg.default;
} else if (MagicStringPkg.MagicString !== undefined) {
    MagicString = MagicStringPkg.MagicString;
}
